...
Só `r round(pct, 2)`% das previsões ficaram dentro de nosso limite. Este seria aceitável à comunidade imobiliário lá. Este reforça a opinião que o modelo ainda precisa trabalho para chegar ao nível comercialmente viável.
...
Usando toda essa informação, vocês vão elaborar `modelo3`. Este modelo deve as seguintes mudanças:
